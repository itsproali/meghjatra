...
- **`/gallery`** — ছবি শেয়ার। **যে কেউ ছবি আপলোড করতে পারবে, সবাই দেখতে ও ডাউনলোড করতে পারবে।** ছবি **অ্যালবামে** সাজানো — আপলোডের সময় একটা অ্যালবাম বাছতে হয় বা নতুন বানাতে হয় (সর্বোচ্চ ১৫টা অ্যালবাম)। দেখার সময় অ্যালবাম দিয়ে ফিল্টার করা যায়।
...
2. **SQL Editor** → নিচের কোড paste করে **Run** করো:
   ...
   > আগে থেকে `photos` টেবিল বানানো থাকলে শুধু অ্যালবাম কলামটা যোগ করো:
   >
   > ```sql
   > alter table photos add column if not exists folder text;
   > ```
